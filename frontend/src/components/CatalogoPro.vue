        ...
        <aside class="sidebar">
          ...
          <div class="links-container">
            <div class="link-section">
              <a href="#" class="link-item"> <i class="uil uil-estate"></i> Inicio </a>
              <a href="#" class="link-item"> <i class="uil uil-tv-retro"></i> Por Ver </a>
            </div>
            <div class="section-separator"></div>
            <div class="link-section">
              <h4 class="section-title">Cuenta</h4>
              <a href="#" class="link-item"> <i class="uil uil-user-square"></i> Tu Perfil </a>
              <a href="#" class="link-item"> <i class="uil uil-clock"></i> Cerrar Sesion </a>
            </div>
            <div class="section-separator"></div>
            <div class="link-section">
              <h4 class="section-title">Explorar</h4>
              <a href="#" class="link-item"> <i class="uil uil-fire"></i> Tendencias </a>
              <a href="#" class="link-item"> <i class="uil uil-music"></i> Series </a>
              <a href="#" class="link-item"> <i class="uil uil-basketball"></i> Cartelera </a>
            </div>
            <div class="section-separator"></div>
            <div class="section-separator"></div>
          </div>
